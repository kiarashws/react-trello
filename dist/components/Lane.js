...
var Lane = function (_Component) {
  ...
  function Lane() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Lane.__proto__ || (0, _getPrototypeOf2.default)(Lane)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var card = (0, _extends3.default)({}, params, {
        id: id
      });
      ...
      if (addedIndex != null) {
        _this.props.actions.moveCardAcrossLanes({ fromLaneId: payload.laneId, toLaneId: laneId, cardId: payload.id, index: addedIndex });
      ...
      var cardList = _this.sortCards(showableCards, laneSortFunction).map(function (card, idx) {
        var cardToRender = _react2.default.createElement(_Card2.default, (0, _extends3.default)({ key: card.id, index: idx, customCardLayout: _this.props.customCardLayout, customCard: _this.props.children, tagStyle: tagStyle, cardStyle: cardStyle, removeCard: _this.removeCard, onClick: function onClick(e) {
            return _this.handleCardClick(e, card);
          }, onDelete: _this.props.onCardDelete, editable: editable, hideCardDeleteIcon: hideCardDeleteIcon }, card));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Container2.default,
            { orientation: 'vertical', groupName: 'TrelloLane', dragClass: cardDragClass, onDragStart: _this.onDragStart, onDrop: function onDrop(e) {
              ...
              }, shouldAcceptDrop: _this.shouldAcceptDrop, getChildPayload: function getChildPayload(index) {
